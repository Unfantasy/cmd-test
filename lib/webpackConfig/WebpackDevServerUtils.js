...
function printInstructions(appName, urls, projectName) {
  console.log();
  console.log(`current project：   ${chalk.cyan(appName)}`);
  console.log(`current entry：     ${chalk.cyan(projectName)}`);
  ...
  console.log();
  // console.timeEnd(chalk.cyan('启动用时'));
  console.log();
...
function createCompiler(webpack, config, appName, urls, projectName) {
  ...
  compiler.plugin('done', stats => {
    ...
    if (isSuccessful && (isInteractive || isFirstCompile)) {
      printInstructions(appName, urls, projectName);
    }
